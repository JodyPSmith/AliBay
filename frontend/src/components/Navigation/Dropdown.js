...
class Dropdown extends Component {
  ...
  render() {
    ...
    const { isSignedIn, setSignIn, setSignOut, checkUser } = this.props;
    return (
      <div className="dropdown">
        ...
        <div id="myDropdown" className="dropdown-content bg-white shadow-1 mr4">
          ...
          >
            <Scroll shadow="">
              <SignUpPage
                ...
                toggleSignUp={this.toggleSignUpModal}
              />
            </Scroll>
          </Modal>
          <Modal
